...
app.post("/submit", (req, res) => {
  ...
  let randomNounNo = Math.floor(Math.random() * noun.length);
  let randomNoun = noun[randomNounNo];
  let randomAdjNo = Math.floor(Math.random() * adj.length);
  let randomAdj = adj[randomAdjNo];
